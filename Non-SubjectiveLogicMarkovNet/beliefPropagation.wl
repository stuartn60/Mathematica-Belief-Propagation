...
(***************)
(***************)
assignmentOfFactortoClique=Intersection@@(First/@Position[cliqueList,#]&/@#)&/@First/@factorList;
assignmentOfCliqueToFactor=Fold[Join[#1,{If[SameQ[Complement[#2,Flatten@#1],{}],{First@#2},Complement[#2,Flatten@#1]]}]&,{},First/@Position[assignmentOfFactortoClique,#]&/@Range@Length@cliqueList];
(***************)
(***************)
(***************)
...
computeApproxMarginalsBP[f_,e_:{},isMax_:False,useSmartMP_:True,threshhold_:10^-6]:=computeMarginalsBP[First@clusterGraphCalibrate[createClusterGraph[f,e],isMax,useSmartMP,threshhold],isMax]
